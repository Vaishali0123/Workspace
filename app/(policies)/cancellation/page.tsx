...
const page = () => {
  return (
    <>
      <div className="flex justify-center items-center select-none px-4 md:px-0 bg-gradient-to-r h-full bg-white">
        <div className="grid grid-cols-1 w-[85%] my-2 sm:my-6 text-black">
          ...
          <div className="text-sm font-thin pp:text-[18px] ">
            ...
            businesses, organizations, and individuals to run ads tailored to
            their targeted audience. Users can select categories, define their
            audience based on relevant interests, location, and age
            demographics, and optimize campaigns by setting daily and total
            budgets for efficient performance.
          </div>
          ...
          <div className="text-[15px] pp:text-[18px] ">
            ...
            cancellations for any advertising services. Once an ad campaign has
            been launched, it cannot be modified, canceled, or refunded. We
            encourage all users to carefully review their campaign settings,
            budgets, and target audience before finalizing their ads.
          </div>
          <h1 className="text-2xl font-semibold py-4 sm:py-5 text-black">
            Contact Us
          </h1>
          <div className="text-[15px] pp:text-[18px] ">
            If you have any questions regarding our policies, please contact our
            support team at grovyoventures@gmail.com. We are here to assist you
            with optimizing your advertising experience on Grovyo Workspace.
          </div>
        </div>
      </div>
    </>
