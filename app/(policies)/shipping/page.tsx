      ...
      <div className="flex justify-center items-center select-none px-4 md:px-0 bg-white">
        <div className="grid grid-cols-1 w-[85%] my-2 sm:my-6 text-black">
          ...
          <div className="text-[15px] mt-3 pp:text-[18px] ">
            Welcome to Grovyo WorkSpace! This Shipping and Delivery Policy
            outlines the terms and procedures for the delivery of digital
            advertising services purchased through our platform. By using Grovyo
            WorkSpace, you agree to adhere to the terms set forth in this
            policy.
          </div>
          <div className="mt-3 font-medium">
            Grovyo WorkSpace is an advanced advertisement platform that enables
            businesses, organizations, and individuals to run targeted ad
            campaigns.
          </div>
          <h1 className="text-xl font-semibold py-4 sm:py-5 text-black">
            Order Processing and Fulfillment
          </h1>
          <div className="text-[15px] pp:text-[18px] ">
            Order Confirmation: Once you place an order for an ad campaign on
            Grovyo WorkSpace, you will receive an order confirmation email
            containing the details of your purchase.
          </div>
          <div className="text-[15px] pp:text-[18px] ">
            Processing Time: Ad campaigns are typically processed within 1-3
            business days before going live, depending on compliance reviews and
            approval.
          </div>
          <div className="text-[15px] pp:text-[18px] ">
            Campaign Activation: Once your ad is approved, it will be scheduled
            to go live based on the start date selected during setup.
          </div>
          <h1 className="text-xl font-semibold py-4 sm:py-5 text-black">
            Delivery & Performance Monitoring
          </h1>
          <div className="text-[15px] pp:text-[18px] ">
            Ad Delivery: Your ads will be displayed to your selected audience
            based on the targeting settings you chose.
          </div>
          <div className="text-[15px] pp:text-[18px] ">
            Performance Tracking: You can track the performance of your ads in
            real-time through your campaign dashboard.
          </div>
          <h1 className="text-xl font-semibold py-4 sm:py-5 text-black">
            Refunds & Cancellations
          </h1>
          <div className="text-[15px] pp:text-[18px] ">
            Please note that Grovyo WorkSpace does not offer refunds or
            cancellations once an ad campaign has been approved and launched.
            Users are encouraged to review their campaign settings carefully
            before submission.
          </div>
          <h1 className="text-xl font-semibold py-4 sm:py-5 text-black">
            Contact Us
          ...
          <div className="text-[15px] pp:text-[18px] ">
            ...
            support team at grovyoinc@gmail.com. We are here to help you
            optimize your advertising experience on Grovyo WorkSpace.
          </div>
        </div>
      </div>
    </>
